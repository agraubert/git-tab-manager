...
export class TabControl {
  ...
  constructor() {
    ...
    this.subscriptions.add(atom.config.observe("core.closeDeletedFileTabs", (value)=>{
      if (value) {
        atom.notifications.addWarning(
          "Git-Tab-Manager: Close Deleted File Tabs is enabled",
          {
            'detail': "The Atom Core setting 'Close Deleted File Tabs' is enabled. "+
            "This may prevent Git-Tab-Manager from working properly. "+
            "Please disable this setting to ensure that Git-Tab-Manager can properly stash "+
            "and restore your tabs",
            'dismissable': true
          }
        );
      }
